...
import io.apitestbase.auth.AuthResponseFilter;
import io.apitestbase.auth.ResourceAuthenticator;
import io.apitestbase.auth.ResourceAuthorizer;
...
public class APITestBaseApplication extends Application<APITestBaseConfiguration> {
    ...
    private void createSystemResources(APITestBaseConfiguration configuration, Environment environment, Jdbi systemDBJdbi,
        ...
        environment.jersey().register(new TeststepResource(appInfo, teststepDAO, udpDAO, utilsDAO, dataTableDAO, assertionDAO, endpointDAO));
