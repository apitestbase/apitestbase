...
angular.module('apitestbase').controller('SFTPTeststepActionController', ['$scope', 'GeneralUtils', '$timeout',
  ...
  function($scope, GeneralUtils, $timeout, Teststeps, Upload, $window) {
    ...
    $scope.actionInfoIncomplete = function() {
      ...
      return !otherProperties.remoteFilePath ||
        (apiRequest.minClassName === '.SftpPutRequestFileFromText' && !apiRequest.fileContent) ||
        (apiRequest.minClassName === '.SftpPutRequestFileFromFile' && !apiRequest.fileName);
    };
