...
angular.module('apitestbase').controller('TeststepDataTableController', ['$scope', '$stateParams', 'TeststepDataTable',
    'DataTableUtils',
  function($scope, $stateParams, TeststepDataTable, DataTableUtils) {
    ...
    $scope.stringCellDblClicked = function(rowEntity, col) {
      DataTableUtils.stringCellDblClicked($scope, TeststepDataTable, rowEntity, col);
    };
  }
]);