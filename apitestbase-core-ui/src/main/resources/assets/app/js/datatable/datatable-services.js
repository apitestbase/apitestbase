...
]).factory('DataTableUtils', ['$timeout', '$rootScope', 'GeneralUtils', '$uibModal',
  function ($timeout, $rootScope, GeneralUtils, $uibModal) {
    ...
    var updateStringCell = function(scope, restService, cellId, oldValue, newValue) {
    ...
    return {
      ...
      updateStringCell: function(scope, restService, cellId, oldValue, newValue) {
        updateStringCell(scope, restService, cellId, oldValue, newValue);
      },

      stringCellDblClicked: function(scope, restService, rowEntity, col) {
        ...
        modalInstance.result.then(function closed() {}, function dismissed() {
          ...
          updateStringCell(scope, restService, rowEntity[columnName].id, oldValue, newValue);
        });
      }
    };
  }
